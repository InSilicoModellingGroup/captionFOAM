...
defineTypeNameAndDebug(voltagePulsed, 0);
addToRunTimeSelectionTable(voltageHandlerBase, voltagePulsed, voltageWaveform);

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
voltagePulsed::voltagePulsed
(
    const fvMesh& mesh, 
    ...
    voltageHandlerBase(mesh, dict, voltExt, voltExtAmp)
{ }

// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
volScalarField voltagePulsed::calcVoltage()
{
