...
#include "speciesWallFluxCorrectedFvPatchScalarField.H"
...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
speciesWallFluxCorrectedFvPatchScalarField::speciesWallFluxCorrectedFvPatchScalarField
(
    const fvPatch& p,
...
speciesWallFluxCorrectedFvPatchScalarField::speciesWallFluxCorrectedFvPatchScalarField
(
    const speciesWallFluxCorrectedFvPatchScalarField& rhs,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
void speciesWallFluxCorrectedFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    scalarField C1 = -(1.0-reflectionFraction_)/(1.0+reflectionFraction_)*0.5*sqrt(uthPrefactor_*T) + ((1.0-alpha*(1.0-reflectionFraction_))/(1.0+reflectionFraction_))*2.0*chargeNumber_*mu*EdotN;
...
namespace Foam
{
    ...
    (
        fvPatchScalarField,
        speciesWallFluxCorrectedFvPatchScalarField
    );
}
