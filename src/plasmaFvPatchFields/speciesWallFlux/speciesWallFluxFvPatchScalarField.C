...
#include "speciesWallFluxFvPatchScalarField.H"
...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
speciesWallFluxFvPatchScalarField::speciesWallFluxFvPatchScalarField
(
    const fvPatch& p,
...
speciesWallFluxFvPatchScalarField::speciesWallFluxFvPatchScalarField
(
    const speciesWallFluxFvPatchScalarField& rhs,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
void speciesWallFluxFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void speciesWallFluxFvPatchScalarField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchScalarField,
        speciesWallFluxFvPatchScalarField
    );
}
